...
public static BrowserMobProxyServer proxy;
	...
	public static void main(String[] args) throws IOException {
		...
		List<String> skus = Files.readAllLines(new File("src/main/resources/test-data/sku-data").toPath(), Charset.defaultCharset());
		...
		Path out = Paths.get("src/main/resources/output.txt");
